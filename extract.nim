...
proc extract(CsElementAccessExpression, info: Info): CsElementAccessExpression = discard #TODO
...
proc extract(CsParenthesizedExpression, info: Info): CsParenthesizedExpression = discard #TODO
...
proc extract(CsArrayCreationExpression, info: Info): CsArrayCreationExpression = discard #TODO
...
proc extract(CsMemberBindingExpression, info: Info): CsMemberBindingExpression = discard #TODO
...
proc extract(CsClassOrStructConstraint, info: Info): CsClassOrStructConstraint = discard #TODO
